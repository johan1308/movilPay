    ...
    <>
      ...
      <div className={configTaiwind.animateView}>
        <div className="grid gap-4 grid-cols-7">
          <div className="col-span-full lg:col-span-5 bg-white p-5 h-full dark:bg-primaryDark rounded-xl shadow-md">
          ...
          <div className="col-span-full lg:col-span-2">
            <div className="relative flex justify-between gap-x-1 py-5 px-3 bg-white dark:bg-primaryDark shadow-md rounded-xl ">
