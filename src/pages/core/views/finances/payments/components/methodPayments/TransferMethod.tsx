...
import { HiDevicePhoneMobile, HiMiniArrowsRightLeft } from "react-icons/hi2";
...
export const TransferMethod = ({ setOpenSlice, setHandleRefresh }: Props) => {
  ...
  return (
    <>
      <PLayouts
        ...
        icon={<HiMiniArrowsRightLeft  className="inline h-6 w-6 ml-2 mb-2" />}
      />
