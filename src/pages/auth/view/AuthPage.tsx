...
export const AuthPage = () => {
  return (
    <>
      <div className="min-w-screen min-h-screen bg-secondary flex items-center justify-center px-5 py-5">
        <div
          ...
          <div className="md:flex w-full">
            <div className="hidden md:block w-1/2 bg-gray-300 py-10 px-10">
              <div className="flex justify-center ">
                <img className="h-44 " src={require('../../../assets/img/logotipo_letras_blancas_movil_play_23x14cm.png')}/>
              </div>
              <svg
            ...
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              <div className="text-center mb-10">
                <h1 className="font-bold text-3xl text-gray-900">INGRESAR</h1>
