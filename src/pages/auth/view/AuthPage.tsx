...
export const AuthPage = () => {
  return (
    <>
      ...
      <section className="min-h-screen flex items-stretch text-white bg-black z-20 " style={{ overflowY: 'hidden' }}>
        <div
        ...
        >
          <div
            className="absolute lg:hidden z-10 inset-0 bg-black  bg-cover items-center"
          >
            <div className="absolute bg-black opacity-60 inset-0 z-0">
              <AuthWorld />
            </div>
          ...
          <div className="w-full  z-20 ">
            ...
            <div className="my-6  flex justify-center">
              <Image src={require('../../../assets/img/logotipo_letras_blancas_movil_play_23x14cm.png')} className=" h-44 " />
            </div>
